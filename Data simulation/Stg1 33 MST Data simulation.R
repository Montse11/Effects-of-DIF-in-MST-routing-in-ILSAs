...
Slope = itembank[, 4]
Location = itempar[, 3] # this is for selecting the DIF introduced to only 33%
...
path <- "C:/Users/mbvaldiv/Desktop/DIF in MST Results/"
Ntheta = 1000
NoReps <- c(3000)
nrSamples = 100
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.25.33.p1", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.25.33.p2", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.25.33.p3", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.50.33.p1", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.50.33.p2", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.50.33.p3", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.1.33.p1", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.1.33.p2", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.1.33.p3", "_i", i, ".Rbin"))
