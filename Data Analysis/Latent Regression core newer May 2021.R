...
#data1= loadObject("D:/DIF in MST Routing in ILSA/DIF in MST Results/NoDIF/Reference/Reference.p1/Core.R.p1_i50.Rbin")

#acountry = loadObject("D:/DIF in MST Routing in ILSA/DIF in MST Analysis/Results Latent Regression/Person Parameter Results/Country/Core.1_p3.Rbin")

# Call true item parameters
# itempar = read.csv("D:/DIF in MST Routing in ILSA/Simulation MST/Data/Test assemble/Core.test.1.csv", header = T)
...
latent_reg = function(data, j, k, l, m){
  ...
  saveObject(estimated_items, file = paste0(path5,"Core.", m, "_", l, "_", k, "_p", j,".Rbin"))
  path6 <- "D:/DIF in MST Routing in ILSA/DIF in MST Analysis/Results Latent Regression/Item Parameters/"
  saveObject(tam.mod, file = paste0(path6,"Core.", m, "_", l, "_", k, "_p", j,".Rbin"))
  ...
  #saveObject(latent_model, file = paste0(path2,"Core.", m, "_", l, "_", k, "_p", j,".Rbin"))
  ...
  saveObject(Results, file = paste0(path4, "Country and mstpath/" ,"Core.", m, "_", l, "_", k, "_p", j,".Rbin"))
  # saveObject(Results_bycountry, file = paste0(path4, "Country/" ,"Core.",  k, "_p", j,".Rbin"))
...
itempar = read.csv("D:/DIF in MST Routing in ILSA/Simulation MST/Data/Test assemble/core.test.1.csv",
                   header = T)
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.1/core.1.11/core.1.11.p1/")
...
clusterExport(cl,list('latent_reg', 'core', 'it', 'background_10', 'R.utils',
                      'saveObject'), envir=environment())


parSapply(cl, 1:100, function(j) latent_reg(core, j, k = 1, l = 11, m = 1 ))
...
#=====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.1/core.1.11/core.1.11.p2/")
...
parSapply(cl, 1:100, function(j) latent_reg(core, j, k = .7, l = 11, m = 1 ))
...
#====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.1/core.1.11/core.1.11.p3/")
...
parSapply(cl, 1:100, function(j) latent_reg(core, j, k = .5, l = 11, m = 1 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.1/core.1.33/core.1.33.p1/")
...
parSapply(cl, 1:100, function(j) latent_reg(core, j, k = 1, l = 33, m = 1 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.1/core.1.33/core.1.33.p2/")
...
parSapply(cl, 1:100, function(j) latent_reg(core, j, k = .7, l = 33, m = 1 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.1/core.1.33/core.1.33.p3/")
...
parSapply(cl, 1:100, function(j) latent_reg(core, j, k = .5, l = 33, m = 1 ))
# stop the core division
stopCluster(cl)
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.1/core.1.56/core.1.56.p1/")
...
parSapply(cl, 1:100, function(j) latent_reg(core, j, k = 1, l = 56, m = 1 ))
...
#====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.1/core.1.56/core.1.56.p2/")
...
parSapply(cl, 1:100, function(j) latent_reg(core, j, k = .7, l = 56, m = 1 ))
...
#====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.1/core.1.56/core.1.56.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = .5, l = 56, m = 1 ))
...
# Call true item parameters for CORE magnitude 1
itempar = read.csv("D:/DIF in MST Routing in ILSA/Simulation MST/Data/Test assemble/core.test.50.csv",
                   header = T)
itembank = read.csv("D:/DIF in MST Routing in ILSA/Simulation MST/Data/item bank for modules.csv", 
                    header = T)
Slope = itembank[, 4]
...
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.50/core.50.11/core.50.11.p1/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = 1, l = 11, m = .50 ))
# stop the core division
stopCluster(cl)
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.50/core.50.11/core.50.11.p2/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = .7, l = 11, m = .50 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.50/core.50.11/core.50.11.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = .5, l = 11, m = .50 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.50/core.50.33/core.50.33.p1/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = 1, l = 33, m = .50 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.50/core.50.33/core.50.33.p2/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = .7, l = 33, m = .50 ))
...
#====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.50/core.50.33/core.50.33.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = .5, l = 33, m = .50 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.50/core.50.56/core.50.56.p1/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = 1, l = 56, m = .50 ))
# stop the core division
stopCluster(cl)

#====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.50/core.50.56/core.50.56.p2/")
...
parSapply(cl, 1:100, function(j) latent_reg(core, j, k = .7, l = 56, m = .50 ))
# stop the core division
stopCluster(cl)

#====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.50/core.50.56/core.50.56.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = .5, l = 56, m = .50 ))
# stop the core division
stopCluster(cl)
...
# Call true item parameters for CORE magnitude 1
itempar = read.csv("D:/DIF in MST Routing in ILSA/Simulation MST/Data/Test assemble/core.test.25.csv",
                   header = T)
itembank = read.csv("D:/DIF in MST Routing in ILSA/Simulation MST/Data/item bank for modules.csv", 
                    header = T)
Slope = itembank[, 4]
...
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.25/core.25.11/core.25.11.p1/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = 1, l = 11, m = .25 ))
# stop the core division
stopCluster(cl)

#====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.25/core.25.11/core.25.11.p2/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = .7, l = 11, m = .25 ))
...
#====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.25/core.25.11/core.25.11.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = .5, l = 11, m = .25 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.25/core.25.33/core.25.33.p1/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = 1, l = 33, m = .25 ))
...
#====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.25/core.25.33/core.25.33.p2/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = .7, l = 33, m = .25 ))
...
#====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.25/core.25.33/core.25.33.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = .5, l = 33, m = .25 ))
# stop the core division
stopCluster(cl)
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.25/core.25.56/core.25.56.p1/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = 1, l = 56, m = .25 ))
# stop the core division
stopCluster(cl)

#====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.25/core.25.56/core.25.56.p2/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = .7, l = 56, m = .25 ))
# stop the core division
stopCluster(cl)

#====
core = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/core/core.25/core.25.56/core.25.56.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(core, j, k = .5, l = 56, m = .25 ))
