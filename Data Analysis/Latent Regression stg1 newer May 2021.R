...
#acountry = loadObject("D:/DIF in MST Routing in ILSA/DIF in MST Analysis/Results Latent Regression/Person Parameter Results/Country and mstpath/stg1.1_11_1_p4.Rbin")
...
latent_reg = function(data, j, k, l, m){
  ...
  saveObject(estimated_items, file = paste0(path5,"Stg1", m, "_", l, "_", k, "_p", j,".Rbin"))
  path6 <- "D:/DIF in MST Routing in ILSA/DIF in MST Analysis/Results Latent Regression/Item Parameters/"
  saveObject(tam.mod, file = paste0(path6,"Stg1", m, "_", l, "_", k, "_p", j,".Rbin"))
  ...
  #saveObject(latent_model, file = paste0(path2,"Stg1", m, "_", l, "_", k, "_p", j,".Rbin"))
  ...
  Results <- data.frame(rep = rep(j, nrow(th0pvsd)),
                        ...
                        DIFloc = rep("Stage 1", nrow(th0pvsd)),
  ...
  saveObject(Results, file = paste0(path4, "Country and mstpath/" ,"Stg1", m, "_", l, "_", k, "_p", j,".Rbin"))
  # saveObject(Results_bycountry, file = paste0(path4, "Country/" ,"Stg1",  k, "_p", j,".Rbin"))
...
itempar = read.csv("D:/DIF in MST Routing in ILSA/Simulation MST/Data/Test assemble/stg1.test.1.csv",
                   header = T)
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.1/stg1.1.11/stg1.1.11.p1/")
...
clusterExport(cl,list('latent_reg', 'stg1', 'it', 'background_10', 'R.utils',
                      'saveObject'), envir=environment())


parSapply(cl, 1:100, function(j) latent_reg(stg1, j, k = 1, l = 11, m = 1 ))
...
#=====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.1/stg1.1.11/stg1.1.11.p2/")
...
parSapply(cl, 1:100, function(j) latent_reg(stg1, j, k = .7, l = 11, m = 1 ))
...
#====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.1/stg1.1.11/stg1.1.11.p3/")
...
parSapply(cl, 1:100, function(j) latent_reg(stg1, j, k = .5, l = 11, m = 1 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.1/stg1.1.33/stg1.1.33.p1/")
...
parSapply(cl, 1:100, function(j) latent_reg(stg1, j, k = 1, l = 33, m = 1 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.1/stg1.1.33/stg1.1.33.p2/")
...
parSapply(cl, 1:100, function(j) latent_reg(stg1, j, k = .7, l = 33, m = 1 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.1/stg1.1.33/stg1.1.33.p3/")
...
parSapply(cl, 1:100, function(j) latent_reg(stg1, j, k = .5, l = 33, m = 1 ))
# stop the core division
stopCluster(cl)
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.1/stg1.1.56/stg1.1.56.p1/")
...
parSapply(cl, 1:100, function(j) latent_reg(stg1, j, k = 1, l = 56, m = 1 ))
...
#====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.1/stg1.1.56/stg1.1.56.p2/")
...
parSapply(cl, 1:100, function(j) latent_reg(stg1, j, k = .7, l = 56, m = 1 ))
...
#====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.1/stg1.1.56/stg1.1.56.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = .5, l = 56, m = 1 ))
...
# Call true item parameters for CORE magnitude 1
itempar = read.csv("D:/DIF in MST Routing in ILSA/Simulation MST/Data/Test assemble/stg1.test.50.csv",
                   header = T)
itembank = read.csv("D:/DIF in MST Routing in ILSA/Simulation MST/Data/item bank for modules.csv", 
                    header = T)
Slope = itembank[, 4]
...
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.50/stg1.50.11/stg1.50.11.p1/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = 1, l = 11, m = .50 ))
# stop the core division
stopCluster(cl)
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.50/stg1.50.11/stg1.50.11.p2/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = .7, l = 11, m = .50 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.50/stg1.50.11/stg1.50.11.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = .5, l = 11, m = .50 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.50/stg1.50.33/stg1.50.33.p1/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = 1, l = 33, m = .50 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.50/stg1.50.33/stg1.50.33.p2/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = .7, l = 33, m = .50 ))
...
#====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.50/stg1.50.33/stg1.50.33.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = .5, l = 33, m = .50 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.50/stg1.50.56/stg1.50.56.p1/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = 1, l = 56, m = .50 ))
# stop the core division
stopCluster(cl)

#====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.50/stg1.50.56/stg1.50.56.p2/")
...
parSapply(cl, 1:100, function(j) latent_reg(stg1, j, k = .7, l = 56, m = .50 ))
# stop the core division
stopCluster(cl)

#====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.50/stg1.50.56/stg1.50.56.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = .5, l = 56, m = .50 ))
# stop the core division
stopCluster(cl)
...
# Call true item parameters for CORE magnitude 1
itempar = read.csv("D:/DIF in MST Routing in ILSA/Simulation MST/Data/Test assemble/stg1.test.25.csv",
                   header = T)
itembank = read.csv("D:/DIF in MST Routing in ILSA/Simulation MST/Data/item bank for modules.csv", 
                    header = T)
Slope = itembank[, 4]
...
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.25/stg1.25.11/stg1.25.11.p1/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = 1, l = 11, m = .25 ))
# stop the core division
stopCluster(cl)

#====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.25/stg1.25.11/stg1.25.11.p2/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = .7, l = 11, m = .25 ))
...
#====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.25/stg1.25.11/stg1.25.11.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = .5, l = 11, m = .25 ))
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.25/stg1.25.33/stg1.25.33.p1/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = 1, l = 33, m = .25 ))
...
#====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.25/stg1.25.33/stg1.25.33.p2/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = .7, l = 33, m = .25 ))
...
#====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.25/stg1.25.33/stg1.25.33.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = .5, l = 33, m = .25 ))
# stop the core division
stopCluster(cl)
...
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.25/stg1.25.56/stg1.25.56.p1/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = 1, l = 56, m = .25 ))
# stop the core division
stopCluster(cl)

#====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.25/stg1.25.56/stg1.25.56.p2/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = .7, l = 56, m = .25 ))
# stop the core division
stopCluster(cl)

#====
stg1 = NULL
setwd("D:/DIF in MST Routing in ILSA/DIF in MST Results/stg1/stg1.25/stg1.25.56/stg1.25.56.p3/")
...
parSapply(cl, seq_along(1:100), function(j) latent_reg(stg1, j, k = .5, l = 56, m = .25 ))
