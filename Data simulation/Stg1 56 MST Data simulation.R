...
#################################################################################
#Set pathway 
path <- "C:/Users/mbvaldiv/Box Sync/DIF in MST/Simulation MST/Data"
setwd(path)


# Call true item parameters
itempar = read.csv("Test assemble/stg1.test.25.csv", header = T)
itembank = read.csv("item bank for modules.csv", header = T)
Slope = itembank[, 4]
Location = itempar[, 5] # this is for selecting the DIF introduced to only 56%
...
path <- "C:/Users/mbvaldiv/Desktop/DIF in MST Results/stg1/"
Ntheta = 1000
NoReps <- c(3000)
nrSamples = 100
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.25.56.p1", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.25.56.p2", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.25.56.p3", "_i", i, ".Rbin"))
...
# Call true item parameters
itempar = read.csv("Test assemble/stg1.test.50.csv", header = T)
itembank = read.csv("item bank for modules.csv", header = T)
Slope = itembank[, 4]
Location = itempar[, 5] # this is for selecting the DIF introduced to only 56%
it1 = data.frame(Slope, Location)
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.50.56.p1", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.50.56.p2", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.50.56.p3", "_i", i, ".Rbin"))
...
# Call true item parameters
itempar = read.csv("Test assemble/stg1.test.1.csv", header = T)
itembank = read.csv("item bank for modules.csv", header = T)
Slope = itembank[, 4]
Location = itempar[, 5] # this is for selecting the DIF introduced to only 56%
it1 = data.frame(Slope, Location)
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.1.56.p1", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.1.56.p2", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Stg1.1.56.p3", "_i", i, ".Rbin"))
