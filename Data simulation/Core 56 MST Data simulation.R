...
#################################################################################
#Set pathway 
path <- "C:/Users/mbvaldiv/Box/DIF in MST/Simulation MST/Data"
setwd(path)
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Core.25.56.p1", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Core.25.56.p2", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Core.25.56.p3", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Core.50.56.p1", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Core.50.56.p2", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Core.50.56.p3", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Core.1.56.p1", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Core.1.56.p2", "_i", i, ".Rbin"))
...
for (i in 1:50){ 
  ...
  saveObject(data, file = paste0(path, "Core.1.56.p3", "_i", i, ".Rbin"))
