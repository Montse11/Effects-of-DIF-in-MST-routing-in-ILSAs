...
itempar = read.csv("Test assemble/stg2.test.25.csv", header = T)
...
for (i in 1:1){ 
  ...
  saveObject(data, file = paste0(path, "Stg2.25.56.p1", "_i", i, ".Rbin"))
...
for (i in 1:100){ 
  ...
  saveObject(data, file = paste0(path, "Stg2.25.56.p2", "_i", i, ".Rbin"))
...
for (i in 1:100){ 
  ...
  saveObject(data, file = paste0(path, "Stg2.25.56.p3", "_i", i, ".Rbin"))
...
# Call true item parameters
itempar = read.csv("Test assemble/stg2.test.50.csv", header = T)
itembank = read.csv("item bank for modules.csv", header = T)
Slope = itembank[, 4]
Location = itempar[, 5] # this is for selecting the DIF introduced to only 56%
it1 = data.frame(Slope, Location)
...
for (i in 1:100){ 
  ...
  saveObject(data, file = paste0(path, "Stg2.50.56.p1", "_i", i, ".Rbin"))
...
for (i in 1:100){ 
  ...
  saveObject(data, file = paste0(path, "Stg2.50.56.p2", "_i", i, ".Rbin"))
...
for (i in 1:100){ 
  ...
  saveObject(data, file = paste0(path, "Stg2.50.56.p3", "_i", i, ".Rbin"))
...
# Call true item parameters
itempar = read.csv("Test assemble/stg2.test.1.csv", header = T)
itembank = read.csv("item bank for modules.csv", header = T)
Slope = itembank[, 4]
Location = itempar[, 5] # this is for selecting the DIF introduced to only 56%
it1 = data.frame(Slope, Location)
...
for (i in 1:100){ 
  ...
  saveObject(data, file = paste0(path, "Stg2.1.56.p1", "_i", i, ".Rbin"))
...
for (i in 1:100){ 
  ...
  saveObject(data, file = paste0(path, "Stg2.1.56.p2", "_i", i, ".Rbin"))
...
for (i in 1:100){ 
  ...
  saveObject(data, file = paste0(path, "Stg2.1.56.p3", "_i", i, ".Rbin"))
